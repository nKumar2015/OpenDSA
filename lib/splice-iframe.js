  ...
  window.addEventListener("load", event => {
    ...
    if (!("SPLICE" in window)) {
      window.SPLICE = {
        ...
        reportScoreAndState: (location, score, scoreData, state) => {
          scores[location] = score;
          states[location] = state;
          // Log received data
          if (window.SPLICE.logging) console.log("SPLICE API reportScoreAndState received:", {location, score, scoreData, state});
